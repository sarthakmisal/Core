...
if(count($orders)==0){
    ...
    <h1 class="display-4">OOPS, Nothing Dispatched Yet!</h1>
    <p class="lead">Go Check Pendings.</p>
    <hr class="my-4">
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-left font-weight-bold text-uppercase">Dispatched Orders</h1>
        </div>
        <div class="col-md-12">
