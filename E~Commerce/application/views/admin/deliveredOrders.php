...
if(count($orders)==0){
    ...
    <h1 class="display-4">OOPS, Nothing Delivered Yet!</h1>
    <p class="lead">Go Check Dispatched Ones.</p>
    <hr class="my-4">
    <p>Serving Customer First is Our Priority .</p>
    <a class="btn btn-primary w-25 btn-lg" style="float:right" href="'.base_url("admin/dispatchedOrders").'" role="button">Delivered Orders</a>
    </div>
    </div>';
}else{
?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-left font-weight-bold text-uppercase">Delivered Orders</h1>
        </div>
        <div class="col-md-12">
