    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/hphp/FORUM">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <?php
                    ...
                    while($row=mysqli_fetch_assoc($cat_list)){
                        ?>
                    <a class="dropdown-item" href="http://localhost/hphp/FORUM/partials/_threadList.php?id=<?=$row['c_id']?>&tii"><?=$row['c_name']?></a>
                    <?php
                    }
                ?>
                </div>
        ...
        <form action="http://localhost/hphp/FORUM/partials/_search.php" method="get" class="form-inline my-2 my-lg-0">
        ...
        ?>
            ...
            <?php
                ...
                ?>
            <a href="http://localhost/hphp/FORUM/partials/_register.php?out"><button class="btn btn-outline-danger  m-2 my-sm-0" type="button">Log Out</button></a>
            <?php
            }
            ?>
    </div>
