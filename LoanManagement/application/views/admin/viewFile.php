			...
			<table class="table">
				<tr>
					...
					<td>
						...
						<p class="font-weight-bold text-muted">&nbsp;&nbsp;&nbsp;&nbsp;&#8377;<?= number_format($viewFile[0]['loan_installment'])?></p>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<h5 class="font-weight-normal">Requested Months</h5>
						<p class="font-weight-bold text-muted">&nbsp;&nbsp;&nbsp;&nbsp;<?=$viewFile[0]['loan_amount']/$viewFile[0]['loan_installment']?></p>
					</td>
					<td>
